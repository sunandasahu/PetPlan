...
public class TC002_GetQuoteAnimal_Cat extends BaseClass {
	public String TestCaseName = "TC002_GetQuoteAnimal_Cat";
	...
	public void TestCase(Hashtable <String,String> data) throws Exception {
		...
		//----------------------------------
		 ...
		 petDetailsPage.petDetails_Cat(data.get("AnimalType"), data.get("Name"), data.get("Gender"), data.get("Neutered"),
